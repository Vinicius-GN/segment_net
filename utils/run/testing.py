...
from utils.metrics.metrics import image_dice, metrics_from_confmat, classification_report_from_confmat
...
def test_model(
    ...
    with torch.no_grad():
        ...
        v_macro_acc_img  = f"{test_macro_acc:2.4f}".rjust(column_width, " ")
        v_macro_miou_img = f"{test_macro_miou:2.4f}".rjust(column_width, " ")
        v_micro_acc_img  = f"{test_micro_acc:2.4f}".rjust(column_width, " ")
        v_micro_miou_img = f"{test_micro_miou:2.4f}".rjust(column_width, " ")
