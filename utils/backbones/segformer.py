...
class SegFormerB3_FPN(BaseBackbone):
    def __init__(self, config):
        super(SegFormerB3_FPN, self).__init__(config, 4)
        segformer_config = SegformerConfig.from_pretrained(
...
class SegFormerB4_FPN(BaseBackbone):
    def __init__(self, config):
        super(SegFormerB4_FPN, self).__init__(config, 4)
        segformer_config = SegformerConfig.from_pretrained(
...
class SegFormerB5_FPN(BaseBackbone):
    def __init__(self, config):
        super(SegFormerB5_FPN, self).__init__(config, 4)
        segformer_config = SegformerConfig.from_pretrained(
